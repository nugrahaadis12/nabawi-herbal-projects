...
<body>
    ...
    <h2 class="container flex justify-center mx-auto">Siswa List</h2>

    <div class="container flex justify-center mx-auto">
        <div class="flex flex-col">
            <div class="w-full">
                <h1 class="text-center text-success"><a href="/siswa/create">Add Nama Siswa list</a></h1>
                    ...
                    <table class="divide-y divide-gray-300 ">
                        ...
                        <tbody class="bg-white divide-y divide-gray-300">
                            ...
                            <tr class="whitespace-nowrap">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900">
                                        @foreach ($data -> extrakurikulers as $item)
                                        - {{$item -> nama}} <br>
                                        @endforeach
                                    </div>
                                </td>
